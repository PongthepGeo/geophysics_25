...
npy_folder = 'ch_05_07_loop_shot'  # Load shot data from this folder (output of ch_05_07_loop_shot.py)
...
migration_npy_path = 'ch_05_08_migration/migration.npy'
migration_save_path = 'ch_05_08_migration/migrated_image.png'
